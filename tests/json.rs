...
mod tests {
    ...
    make_test!(#[ignore] y_array_heterogeneous, "y_array_heterogeneous.json", y);
    make_test!(y_array_null, "y_array_null.json", y);
    make_test!(#[ignore] y_array_with_1_and_newline, "y_array_with_1_and_newline.json", y);
    make_test!(#[ignore] y_array_with_leading_space, "y_array_with_leading_space.json", y);
    make_test!(#[ignore] y_array_with_several_null, "y_array_with_several_null.json", y);
    make_test!(#[ignore] y_array_with_trailing_space, "y_array_with_trailing_space.json", y);
    ...
    make_test!(#[ignore] y_number_after_space, "y_number_after_space.json", y);
    ...
    make_test!(#[ignore] y_number_minus_zero, "y_number_minus_zero.json", y);
    make_test!(#[ignore] y_number_negative_int, "y_number_negative_int.json", y);
    make_test!(#[ignore] y_number_negative_one, "y_number_negative_one.json", y);
    make_test!(#[ignore] y_number_negative_zero, "y_number_negative_zero.json", y);
    ...
    make_test!(#[ignore] y_number_simple_int, "y_number_simple_int.json", y);
    ...
    make_test!(#[ignore] y_object_empty_key, "y_object_empty_key.json", y);
    make_test!(#[ignore] y_object_escaped_null_in_key, "y_object_escaped_null_in_key.json", y);
    ...
    make_test!(#[ignore] y_structure_lonely_int, "y_structure_lonely_int.json", y);
